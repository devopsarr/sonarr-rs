...
pub struct HostConfigResource {
    ...
    #[serde(rename = "allowedHosts", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub allowed_hosts: Option<Option<String>>,
    ...
    #[serde(rename = "trustedNetworks", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub trusted_networks: Option<Option<String>>,
