...
pub struct ImportListExclusionResourcePagingResource {
    ...
    pub records: Option<Option<Vec<models::ImportListExclusionResource>>>,
}

impl ImportListExclusionResourcePagingResource {
    pub fn new() -> ImportListExclusionResourcePagingResource {
